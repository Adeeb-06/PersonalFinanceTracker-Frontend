...
export default function ExpenseCategoryAnalytics() {
  ...
  const categoriesToDisplay = expenseCategories || [];
  ...
  }, [selectedCategory, setExpenseCategory]);
  ...
  const data = expenseCategoryAnalytics?.data;
